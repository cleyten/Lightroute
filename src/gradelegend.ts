// Grade-color legend swatches. Split out from chart.ts (which pulls in the
// heavy chart.js/auto bundle) so this tiny, static, Chart.js-independent
// piece can stay in the app's eagerly-loaded main chunk while the chart
// itself is code-split and lazy-loaded (see main.ts's loadChartModule()).
