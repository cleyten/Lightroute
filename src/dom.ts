...
// which ids the code depends on, and keeps main.ts free of sixty
// querySelector lines.
...
// Status and progress
export const statusEl = el<HTMLElement>('#status');
export const statusBarEl = el<HTMLElement>('#statusbar');
...
export const brandSub = el<HTMLElement>('.brand-sub');
